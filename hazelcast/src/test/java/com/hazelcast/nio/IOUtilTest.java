...
import static com.hazelcast.util.IOUtil.compress;
import static com.hazelcast.util.IOUtil.copy;
import static com.hazelcast.util.IOUtil.copyFile;
import static com.hazelcast.util.IOUtil.copyToHeapBuffer;
import static com.hazelcast.util.IOUtil.decompress;
import static com.hazelcast.util.IOUtil.delete;
import static com.hazelcast.util.IOUtil.deleteQuietly;
import static com.hazelcast.util.IOUtil.getFileFromResources;
import static com.hazelcast.util.IOUtil.getPath;
import static com.hazelcast.util.IOUtil.newInputStream;
import static com.hazelcast.util.IOUtil.newOutputStream;
import static com.hazelcast.util.IOUtil.readAttributeValue;
import static com.hazelcast.util.IOUtil.readByteArray;
import static com.hazelcast.util.IOUtil.readFully;
import static com.hazelcast.util.IOUtil.readFullyOrNothing;
import static com.hazelcast.util.IOUtil.readObject;
import static com.hazelcast.util.IOUtil.rename;
import static com.hazelcast.util.IOUtil.toFileName;
import static com.hazelcast.util.IOUtil.touch;
import static com.hazelcast.util.IOUtil.writeByteArray;
