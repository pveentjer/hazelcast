...
public class SpinningUdpChannel implements Channel {
    private static final int FALSE = 0;
    private static final int TRUE = 1;
    private static final AtomicIntegerFieldUpdater<SpinningUdpChannel> CLOSED = newUpdater(SpinningUdpChannel.class, "closed");
    ...
    public void setWriter(UdpSpinningChannelWriter writer) {
        this.writer = writer;
    }
    ...
    public UdpSpinningChannelWriter getWriter() {
        return writer;
    }
